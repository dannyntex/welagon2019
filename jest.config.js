...
const configureProject = ( displayName, cb) =>
    ...
    Object.assign(
        {
            ...
            // directory.
            testMatch: [path.join('<rootDir>',   testGlob)],
        ...
        cb(path.join.bind(path, '<rootDir>'))
    );
const jestConfig = {
    projects: [

        configureProject( 'Started pwa', inPackage => ({
            ...
            setupFilesAfterEnv: [
                path.join('<rootDir>', 'scripts', 'setupTests.js')
            ],
